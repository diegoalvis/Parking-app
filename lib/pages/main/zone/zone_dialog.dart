...
class ZoneDialog extends StatelessWidget {
  ...
  ZoneDialog(this._zone, this._zoneRepo, this._repo);

  @override
  Widget build(BuildContext context) {
    return InjectorWidget.bind(
      bindFunc: (binder) {
        binder.bindSingleton(ZoneDialogBloc(_zoneRepo, _repo));
      },
          ...
          BlocBuilder(
              ...
              builder: (ctx, state) {
                if(state is InitialState){
                  onWidgetDidBuild(() => _bloc.dispatch(ReadyZone(_zone.idZone, _zone.type)));
                }
