          ...
          builder: (context, state) {
            ...
            if (state is ErrorState) {
              ...
              return RefreshIndicator(onRefresh:(){
                _vehicleBloc.dispatch(ReloadVehicles());
              },
                child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    if (index == 0) {
                      ...
                      return vehicleDetail(context, index - 1);
                    }
                  },
                ),
              );
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: Text(vehicles[index].plate,
                            style: Theme
                                .of(context)
                                .textTheme
                                .subtitle),
                      ...
                      Padding(
                        padding: const EdgeInsets.only(left: 24.0),
                        child: Text(vehicles[index].brand,
                            style: Theme
                                .of(context)
                                .textTheme
                                .body2),
